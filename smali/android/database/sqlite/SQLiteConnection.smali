...
.method private setJournalMode(Ljava/lang/String;)V
    ...
    const-string v5, "Could not change the database journal mode of \'"
    ...
    const-string v5, "\' because the database is locked.  This usually means that "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, "there are other open connections to the database which prevents "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, "the database from enabling or disabling write-ahead logging mode.  "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, "Proceeding without changing the journal mode."
...
.method private setLocaleFromConfiguration()V
    ...
    const-string v5, "REINDEX LOCALIZED"
    ...
    const-string v7, "Failed to change locale for db \'"
...
.method public executeForBlobFileDescriptor(Ljava/lang/String;[Ljava/lang/Object;Landroid/os/CancellationSignal;)Landroid/os/ParcelFileDescriptor;
    ...
    const-string v6, "executeForBlobFileDescriptor"

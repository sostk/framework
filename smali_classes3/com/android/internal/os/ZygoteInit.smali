...
.method private static checkIfDevice()Z
    .locals 4
...
.method private static checkIfModDevice()Z
    .locals 4
...
.method private static checkIfModel()Z
    .locals 4
...
.method private static checkIfName()Z
    .locals 4
...
.method private static checkIfNianBuild()Z
    .locals 3
    ...
    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkIfOwn()Z
    ...
    :cond_0
    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkIfName()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkIfDevice()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkIfModel()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkIfModDevice()Z
    ...
    :cond_2
    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkifGalaxyS3()Z
    ...
    :cond_3
    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkifGalaxyS3LTE()Z
    ...
    :cond_4
    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkifGalaxyS3NTT()Z
    ...
    :cond_5
    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkifGalaxyNote2()Z
    ...
    :cond_6
    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkifGalaxyS4()Z
    ...
    :cond_7
    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkifOneM7()Z
    ...
    :cond_8
    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkifZ11()Z
    ...
    :cond_9
    invoke-static {}, Lcom/android/internal/os/ZygoteInit;->checkifLex2()Z
...
.method private static checkIfOwn()Z
    .locals 2

    .prologue
    const-string v0, "ro.product.own"
...
.method private static checkifGalaxyNote2()Z
    .locals 2
...
.method private static checkifGalaxyS3()Z
    .locals 2
...
.method private static checkifGalaxyS3LTE()Z
    .locals 2
...
.method private static checkifGalaxyS3NTT()Z
    .locals 2
...
.method private static checkifGalaxyS4()Z
    .locals 2
...
.method private static checkifLex2()Z
    .locals 2
...
.method private static checkifOneM7()Z
    .locals 2
...
.method private static checkifZ11()Z
    .locals 2
